...
export class AutomationComponent implements OnInit { 
  ...
  onSearch(txt){ 
    ...
    console.log(this.search_blocks);
  }
  initSortable() { 
    let _this = this;
  ...
  async deployNow() {   
    ...
    this.custHttps.post("deploy-automation/deploy?project_id="+this.projectData.project_id,{
      blocks:this.maindatas,
      word_matches:this.wmatchingdtas
    }).subscribe(async (snap:any)=>{
      console.log(snap);
      this.toast.presentToast("Deployed success.");
